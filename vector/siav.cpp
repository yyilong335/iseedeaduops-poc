...
uint64_t victim_function(size_t x)
{
    ...
    */
    ...
    // vi1 = _mm256_set_epi32(512, 513, 514, 515, 516, 517, 518, 519);
    _mm_mfence();
    //printf("%p\n", x);
    time1 = __rdtscp(&junk);
    ...
    if (x < array1_size) // mispredict
    {
        ...
        // v0 = _mm256_load_si256((__m256i*) &array2[0]);
        // v1 = _mm256_load_si256((__m256i*) &array2[512]);
        // v2 = _mm256_load_si256((__m256i*) &array2[512*2]);
        // v3 = _mm256_load_si256((__m256i*) &array2[512*3]);
